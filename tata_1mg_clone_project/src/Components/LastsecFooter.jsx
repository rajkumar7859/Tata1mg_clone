  ...
  return (
    <>
      <div className="last-sec-div1" style={{ textAlign:"center", padding: "1rem 2rem" }}>
        ...
        <h4 style={{ textAlign:"center"}}>We Bring Care to Health.</h4>
        ...
        <h4 style={{ textAlign:"center"}}>Tata 1mg: Your Favourite Online Pharmacy!</h4>
        <p>
        ...
        <h4 style={{ textAlign:"center"}}>The Feathers in Our Cap</h4>
        <p style={{ textAlign:"center"}}>
        ...
        <h4 style={{ textAlign:"center"}}>The Services We Offer</h4>
        <p style={{ textAlign:"center"}}>
        ...
        <p style={{ textAlign:"center"}}>Stay Healthy!</p>
      </div>
    </>
  );
}
